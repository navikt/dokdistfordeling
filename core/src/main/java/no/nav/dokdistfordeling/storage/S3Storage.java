...
import no.nav.dokdistfordeling.exception.functional.S3FailedToGetDocumentFunctionalException;
import no.nav.dokdistfordeling.exception.functional.S3FailedToPutDocumentFunctionalException;

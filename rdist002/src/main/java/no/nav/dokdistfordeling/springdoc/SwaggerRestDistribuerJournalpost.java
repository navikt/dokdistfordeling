...
@ApiResponses(value = {
		...
		@ApiResponse(responseCode = "400", description = "Ugyldig input. Validering av request body, eller validering av journalposten som journalpostId refererer til feilet."),
		@ApiResponse(responseCode = "401", description = "* Bruker mangler tilgang for å vise journalposten.\n* Ugyldig OIDC token."),
		@ApiResponse(responseCode = "404", description = "Journalposten ble ikke funnet."),
		@ApiResponse(responseCode = "500", description = " Teknisk feil under prosessering av forsendelse.")
}
)
